# modified from https://github.com/qiauil/GIFt/blob/main/GIFt/utils/configs.py
import inspect
...
def load_obj_from_config(path: Optional[str] = None, config_dict: Dict = None):
    """
    ...
    Args:
        ...
        config_dict (dict, optional): The configuration dictionary. Only one of `path` and `config_dict` should be provided.
