...
class ProjectLoader(ScrollerSettings):
    ...
    def load_project(self):
        data_handler, trade_core, start_index, end_index, start_trade_index = load_project(self.folder_select_card.current_folder)
        from ..window.window_basics import TitleMenuWindow
        self.parent_window.close()
        main_trade = MainTrade(data_handler=data_handler, 
